function [nu,gamma,err] = Myquantum_barycenters(mu,c,rho,epsilon,w,options)

% Modified from the original file by introducing initialization
...
nu = getoptions(options, 'nu_init', mu{1});
