...
% subsample
filename = 'fashionmnist_pca75'; %fashionmnist_pca75,mnist_pca75,letter_pca100
m = 250;
n = 100;
d = 5;
k = d;
...
data_train = data_train/255; %division by 255 for fashionMNIST, 1 for mnist, 15 for letter
data_test = data_test/255; %division by 255 for fashionMNIST, 1 for mnist, 15 for letter
